...
//		H2_Dersler ders1 = new H2_Dersler("Muzik", "Math");
//		H1_Ogrenci ogrenci1 = new H1_Ogrenci(111, "Islam Gunebakan", 100, ders1);
//		
...
//		session.save(ogrenci2);
		...
		System.out.println("Silmek istediginz no yu giriniz");
		int no = scan.nextInt();
		session.delete(session.get(H1_Ogrenci.class, no));
		
		// UPDATE ===================================================================================================
		session.get(H1_Ogrenci.class, 222).setAd("Islam");  // Primary key degistirelemez
